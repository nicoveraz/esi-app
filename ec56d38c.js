 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
var v;f[_]=!0,f.elementProperties=new Map,f.elementStyles=[],f.shadowRootOptions={mode:"open"},null==c||c({ReactiveElement:f}),(null!==(a=l.reactiveElementVersions)&&void 0!==a?a:l.reactiveElementVersions=[]).push("1.6.2");const g=window,b=g.trustedTypes,y=b?b.createPolicy("lit-html",{createHTML:e=>e}):void 0,x="$lit$",w=`lit$${(Math.random()+"").slice(9)}$`,C="?"+w,A=`<${C}>`,E=document,I=()=>E.createComment(""),P=e=>null===e||"object"!=typeof e&&"function"!=typeof e,S=Array.isArray,T="[ \t\n\f\r]",O=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,k=/-->/g,N=/>/g,z=RegExp(`>|${T}(?:([^\\s"'>=/]+)(${T}*=${T}*(?:[^ \t\n\f\r"'\`<>=]|("|')|))|$)`,"g"),L=/'/g,R=/"/g,D=/^(?:script|style|textarea|title)$/i,V=(e=>(t,...i)=>({_$litType$:e,strings:t,values:i}))(1),M=Symbol.for("lit-noChange"),$=Symbol.for("lit-nothing"),F=new WeakMap,B=E.createTreeWalker(E,129,null,!1);function H(e,t){if(!Array.isArray(e)||!e.hasOwnProperty("raw"))throw Error("invalid template strings array");return void 0!==y?y.createHTML(t):t}const U=(e,t)=>{const i=e.length-1,o=[];let s,r=2===t?"<svg>":"",n=O;for(let t=0;t<i;t++){const i=e[t];let a,l,d=-1,h=0;for(;h<i.length&&(n.lastIndex=h,l=n.exec(i),null!==l);)h=n.lastIndex,n===O?"!--"===l[1]?n=k:void 0!==l[1]?n=N:void 0!==l[2]?(D.test(l[2])&&(s=RegExp("</"+l[2],"g")),n=z):void 0!==l[3]&&(n=z):n===z?">"===l[0]?(n=null!=s?s:O,d=-1):void 0===l[1]?d=-2:(d=n.lastIndex-l[2].length,a=l[1],n=void 0===l[3]?z:'"'===l[3]?R:L):n===R||n===L?n=z:n===k||n===N?n=O:(n=z,s=void 0);const c=n===z&&e[t+1].startsWith("/>")?" ":"";r+=n===O?i+A:d>=0?(o.push(a),i.slice(0,d)+x+i.slice(d)+w+c):i+w+(-2===d?(o.push(void 0),t):c)}return[H(e,r+(e[i]||"<?>")+(2===t?"</svg>":"")),o]};class q{constructor({strings:e,_$litType$:t},i){let o;this.parts=[];let s=0,r=0;const n=e.length-1,a=this.parts,[l,d]=U(e,t);if(this.el=q.createElement(l,i),B.currentNode=this.el.content,2===t){const e=this.el.content,t=e.firstChild;t.remove(),e.append(...t.childNodes)}for(;null!==(o=B.nextNode())&&a.length<n;){if(1===o.nodeType){if(o.hasAttributes()){const e=[];for(const t of o.getAttributeNames())if(t.endsWith(x)||t.startsWith(w)){const i=d[r++];if(e.push(t),void 0!==i){const e=o.getAttribute(i.toLowerCase()+x).split(w),t=/([.?@])?(.*)/.exec(i);a.push({type:1,index:s,name:t[2],strings:e,ctor:"."===t[1]?K:"?"===t[1]?X:"@"===t[1]?Z:G})}else a.push({type:6,index:s})}for(const t of e)o.removeAttribute(t)}if(D.test(o.tagName)){const e=o.textContent.split(w),t=e.length-1;if(t>0){o.textContent=b?b.emptyScript:"";for(let i=0;i<t;i++)o.append(e[i],I()),B.nextNode(),a.push({type:2,index:++s});o.append(e[t],I())}}}else if(8===o.nodeType)if(o.data===C)a.push({type:2,index:s});else{let e=-1;for(;-1!==(e=o.data.indexOf(w,e+1));)a.push({type:7,index:s}),e+=w.length-1}s++}}static createElement(e,t){const i=E.createElement("template");return i.innerHTML=e,i}}function j(e,t,i=e,o){var s,r,n,a;if(t===M)return t;let l=void 0!==o?null===(s=i._$Co)||void 0===s?void 0:s[o]:i._$Cl;const d=P(t)?void 0:t._$litDirective$;return(null==l?void 0:l.constructor)!==d&&(null===(r=null==l?void 0:l._$AO)||void 0===r||r.call(l,!1),void 0===d?l=void 0:(l=new d(e),l._$AT(e,i,o)),void 0!==o?(null!==(n=(a=i)._$Co)&&void 0!==n?n:a._$Co=[])[o]=l:i._$Cl=l),void 0!==l&&(t=j(e,l._$AS(e,t.values),l,o)),t}class W{constructor(e,t){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=t}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){var t;const{el:{content:i},parts:o}=this._$AD,s=(null!==(t=null==e?void 0:e.creationScope)&&void 0!==t?t:E).importNode(i,!0);B.currentNode=s;let r=B.nextNode(),n=0,a=0,l=o[0];for(;void 0!==l;){if(n===l.index){let t;2===l.type?t=new Y(r,r.nextSibling,this,e):1===l.type?t=new l.ctor(r,l.name,l.strings,this,e):6===l.type&&(t=new Q(r,this,e)),this._$AV.push(t),l=o[++a]}n!==(null==l?void 0:l.index)&&(r=B.nextNode(),n++)}return B.currentNode=E,s}v(e){let t=0;for(const i of this._$AV)void 0!==i&&(void 0!==i.strings?(i._$AI(e,i,t),t+=i.strings.length-2):i._$AI(e[t])),t++}}class Y{constructor(e,t,i,o){var s;this.type=2,this._$AH=$,this._$AN=void 0,this._$AA=e,this._$AB=t,this._$AM=i,this.options=o,this._$Cp=null===(s=null==o?void 0:o.isConnected)||void 0===s||s}get _$AU(){var e,t;return null!==(t=null===(e=this._$AM)||void 0===e?void 0:e._$AU)&&void 0!==t?t:this._$Cp}get parentNode(){let e=this._$AA.parentNode;const t=this._$AM;return void 0!==t&&11===(null==e?void 0:e.nodeType)&&(e=t.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,t=this){e=j(this,e,t),P(e)?e===$||null==e||""===e?(this._$AH!==$&&this._$AR(),this._$AH=$):e!==this._$AH&&e!==M&&this._(e):void 0!==e._$litType$?this.g(e):void 0!==e.nodeType?this.$(e):(e=>S(e)||"function"==typeof(null==e?void 0:e[Symbol.iterator]))(e)?this.T(e):this._(e)}k(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}$(e){this._$AH!==e&&(this._$AR(),this._$AH=this.k(e))}_(e){this._$AH!==$&&P(this._$AH)?this._$AA.nextSibling.data=e:this.$(E.createTextNode(e)),this._$AH=e}g(e){var t;const{values:i,_$litType$:o}=e,s="number"==typeof o?this._$AC(e):(void 0===o.el&&(o.el=q.createElement(H(o.h,o.h[0]),this.options)),o);if((null===(t=this._$AH)||void 0===t?void 0:t._$AD)===s)this._$AH.v(i);else{const e=new W(s,this),t=e.u(this.options);e.v(i),this.$(t),this._$AH=e}}_$AC(e){let t=F.get(e.strings);return void 0===t&&F.set(e.strings,t=new q(e)),t}T(e){S(this._$AH)||(this._$AH=[],this._$AR());const t=this._$AH;let i,o=0;for(const s of e)o===t.length?t.push(i=new Y(this.k(I()),this.k(I()),this,this.options)):i=t[o],i._$AI(s),o++;o<t.length&&(this._$AR(i&&i._$AB.nextSibling,o),t.length=o)}_$AR(e=this._$AA.nextSibling,t){var i;for(null===(i=this._$AP)||void 0===i||i.call(this,!1,!0,t);e&&e!==this._$AB;){const t=e.nextSibling;e.remove(),e=t}}setConnected(e){var t;void 0===this._$AM&&(this._$Cp=e,null===(t=this._$AP)||void 0===t||t.call(this,e))}}class G{constructor(e,t,i,o,s){this.type=1,this._$AH=$,this._$AN=void 0,this.element=e,this.name=t,this._$AM=o,this.options=s,i.length>2||""!==i[0]||""!==i[1]?(this._$AH=Array(i.length-1).fill(new String),this.strings=i):this._$AH=$}get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}_$AI(e,t=this,i,o){const s=this.strings;let r=!1;if(void 0===s)e=j(this,e,t,0),r=!P(e)||e!==this._$AH&&e!==M,r&&(this._$AH=e);else{const o=e;let n,a;for(e=s[0],n=0;n<s.length-1;n++)a=j(this,o[i+n],t,n),a===M&&(a=this._$AH[n]),r||(r=!P(a)||a!==this._$AH[n]),a===$?e=$:e!==$&&(e+=(null!=a?a:"")+s[n+1]),this._$AH[n]=a}r&&!o&&this.j(e)}j(e){e===$?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,null!=e?e:"")}}class K extends G{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===$?void 0:e}}const J=b?b.emptyScript:"";class X extends G{constructor(){super(...arguments),this.type=4}j(e){e&&e!==$?this.element.setAttribute(this.name,J):this.element.removeAttribute(this.name)}}class Z extends G{constructor(e,t,i,o,s){super(e,t,i,o,s),this.type=5}_$AI(e,t=this){var i;if((e=null!==(i=j(this,e,t,0))&&void 0!==i?i:$)===M)return;const o=this._$AH,s=e===$&&o!==$||e.capture!==o.capture||e.once!==o.once||e.passive!==o.passive,r=e!==$&&(o===$||s);s&&this.element.removeEventListener(this.name,this,o),r&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var t,i;"function"==typeof this._$AH?this._$AH.call(null!==(i=null===(t=this.options)||void 0===t?void 0:t.host)&&void 0!==i?i:this.element,e):this._$AH.handleEvent(e)}}class Q{constructor(e,t,i){this.element=e,this.type=6,this._$AN=void 0,this._$AM=t,this.options=i}get _$AU(){return this._$AM._$AU}_$AI(e){j(this,e)}}const ee=g.litHtmlPolyfillSupport;null==ee||ee(q,Y),(null!==(v=g.litHtmlVersions)&&void 0!==v?v:g.litHtmlVersions=[]).push("2.7.5");
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/let Ce=0,Ae=0,Ee=[],Ie=0,Pe=!1,Se=document.createTextNode("");new window.MutationObserver((function(){Pe=!1;const e=Ee.length;for(let t=0;t<e;t++){let e=Ee[t];if(e)try{e()}catch(e){setTimeout((()=>{throw e}))}}Ee.splice(0,e),Ae+=e})).observe(Se,{characterData:!0});const Te={run:e=>(Pe||(Pe=!0,Se.textContent=Ie++),Ee.push(e),Ce++),cancel(e){const t=e-Ae;if(t>=0){if(!Ee[t])throw new Error("invalid async handle: "+e);Ee[t]=null}}},Oe=window.ShadyDOM&&window.ShadyDOM.noPatch&&window.ShadyDOM.wrap?window.ShadyDOM.wrap:window.ShadyDOM?e=>ShadyDOM.patch(e):e=>e
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/let it={},ot={};function st(e,t){it[e]=ot[e.toLowerCase()]=t}function rt(e){return it[e]||ot[e.toLowerCase()]}class nt extends HTMLElement{static get observedAttributes(){return["id"]}static import(e,t){if(e){let i=rt(e);return i&&t?i.querySelector(t):i}return null}attributeChangedCallback(e,t,i,o){t!==i&&this.register()}get assetpath(){if(!this.__assetpath){const e=window.HTMLImports&&HTMLImports.importForElement?HTMLImports.importForElement(this)||document:this.ownerDocument,t=Ve(this.getAttribute("assetpath")||"",e.baseURI);this.__assetpath=$e(t)}return this.__assetpath}register(e){if(e=e||this.id){if(qe&&void 0!==rt(e))throw st(e,null),new Error(`strictTemplatePolicy: dom-module ${e} re-registered`);this.id=e,st(e,this),(t=this).querySelector("style")&&console.warn("dom-module %s has style outside template",t.id)}var t}}nt.prototype.modules=it,customElements.define("dom-module",nt);
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/let Dt=!1,Vt=!1;function Mt(e){(function(){if(!Dt){Dt=!0;const e=document.createElement("textarea");e.placeholder="a",Vt=e.placeholder===e.textContent}return Vt})()&&"textarea"===e.localName&&e.placeholder&&e.placeholder===e.textContent&&(e.textContent=null)}const $t=(()=>{const e=window.trustedTypes&&window.trustedTypes.createPolicy("polymer-template-event-attribute-policy",{createScript:e=>e});return(t,i,o)=>{const s=i.getAttribute(o);e&&o.startsWith("on-")?t.setAttribute(o,e.createScript(s,o)):t.setAttribute(o,s)}})();function Ft(e){let t=e.getAttribute("is");if(t&&Rt[t]){let i=e;for(i.removeAttribute("is"),e=i.ownerDocument.createElement(t),i.parentNode.replaceChild(e,i),e.appendChild(i);i.attributes.length;){const{name:t}=i.attributes[0];$t(e,i,t),i.removeAttribute(t)}}return e}function Bt(e,t){let i=t.parentInfo&&Bt(e,t.parentInfo);if(!i)return e;for(let e=i.firstChild,o=0;e;e=e.nextSibling)if(t.parentIndex===o++)return e}function Ht(e,t,i,o){o.id&&(t[o.id]=i)}function Ut(e,t,i){if(i.events&&i.events.length)for(let o,s=0,r=i.events;s<r.length&&(o=r[s]);s++)e._addMethodEventListenerToNode(t,o.name,o.value,e)}function qt(e,t,i,o){i.templateInfo&&(t._templateInfo=i.templateInfo,t._parentTemplateInfo=o)}const jt=tt((e=>class extends e{static _parseTemplate(e,t){if(!e._templateInfo){let i=e._templateInfo={};i.nodeInfoList=[],i.nestedTemplate=Boolean(t),i.stripWhiteSpace=t&&t.stripWhiteSpace||e.hasAttribute&&e.hasAttribute("strip-whitespace"),this._parseTemplateContent(e,i,{parent:null})}return e._templateInfo}static _parseTemplateContent(e,t,i){return this._parseTemplateNode(e.content,t,i)}static _parseTemplateNode(e,t,i){let o=!1,s=e;return"template"!=s.localName||s.hasAttribute("preserve-content")?"slot"===s.localName&&(t.hasInsertionPoint=!0):o=this._parseTemplateNestedTemplate(s,t,i)||o,Mt(s),s.firstChild&&this._parseTemplateChildNodes(s,t,i),s.hasAttributes&&s.hasAttributes()&&(o=this._parseTemplateNodeAttributes(s,t,i)||o),o||i.noted}static _parseTemplateChildNodes(e,t,i){if("script"!==e.localName&&"style"!==e.localName)for(let o,s=e.firstChild,r=0;s;s=o){if("template"==s.localName&&(s=Ft(s)),o=s.nextSibling,s.nodeType===Node.TEXT_NODE){let i=o;for(;i&&i.nodeType===Node.TEXT_NODE;)s.textContent+=i.textContent,o=i.nextSibling,e.removeChild(i),i=o;if(t.stripWhiteSpace&&!s.textContent.trim()){e.removeChild(s);continue}}let n={parentIndex:r,parentInfo:i};this._parseTemplateNode(s,t,n)&&(n.infoIndex=t.nodeInfoList.push(n)-1),s.parentNode&&r++}}static _parseTemplateNestedTemplate(e,t,i){let o=e,s=this._parseTemplate(o,t);return(s.content=o.content.ownerDocument.createDocumentFragment()).appendChild(o.content),i.templateInfo=s,!0}static _parseTemplateNodeAttributes(e,t,i){let o=!1,s=Array.from(e.attributes);for(let r,n=s.length-1;r=s[n];n--)o=this._parseTemplateNodeAttribute(e,t,i,r.name,r.value)||o;return o}static _parseTemplateNodeAttribute(e,t,i,o,s){return"on-"===o.slice(0,3)?(e.removeAttribute(o),i.events=i.events||[],i.events.push({name:o.slice(3),value:s}),!0):"id"===o&&(i.id=s,!0)}static _contentForTemplate(e){let t=e._templateInfo;return t&&t.content||e.content}_stampTemplate(e,t){e&&!e.content&&window.HTMLTemplateElement&&HTMLTemplateElement.decorate&&HTMLTemplateElement.decorate(e);let i=(t=t||this.constructor._parseTemplate(e)).nodeInfoList,o=t.content||e.content,s=document.importNode(o,!0);s.__noInsertionPoint=!t.hasInsertionPoint;let r=s.nodeList=new Array(i.length);s.$={};for(let e,o=0,n=i.length;o<n&&(e=i[o]);o++){let i=r[o]=Bt(s,e);Ht(0,s.$,i,e),qt(0,i,e,t),Ut(this,i,e)}return s}_addMethodEventListenerToNode(e,t,i,o){let s=function(e,t,i){return e=e._methodHost||e,function(t){e[i]?e[i](t,t.detail):console.warn("listener method `"+i+"` not defined")}}(o=o||e,0,i);return this._addEventListenerToNode(e,t,s),s}_addEventListenerToNode(e,t,i){e.addEventListener(t,i)}_removeEventListenerFromNode(e,t,i){e.removeEventListener(t,i)}}));
/**
 * @fileoverview
 ...
 * Google as part of the polymer project is also subject to an additional IP
 * rights grant found at http://polymer.github.io/PATENTS.txt
 */class zi{constructor(e,t){Di(e,t);const i=t.reduce(((t,i,o)=>t+Li(i)+e[o+1]),e[0]);this.value=i.toString()}toString(){return this.value}}function Li(e){if(e instanceof zi)return e.value;throw new Error(`non-literal value passed to Polymer's htmlLiteral function: ${e}`)}const Ri=function(e,...t){Di(e,t);const i=document.createElement("template");let o=t.reduce(((t,i,o)=>t+function(e){if(e instanceof HTMLTemplateElement)return e.innerHTML;if(e instanceof zi)return Li(e);throw new Error(`non-template value passed to Polymer's html function: ${e}`)}(i)+e[o+1]),e[0]);return Ni&&(o=Ni.createHTML(o)),i.innerHTML=o,i},Di=(e,t)=>{if(!Array.isArray(e)||!Array.isArray(e.raw)||t.length!==e.length-1)throw new TypeError("Invalid call to the html template tag")},Vi=ki(HTMLElement),Mi=/\/\*[\*!]\s+vaadin-dev-mode:start([\s\S]*)vaadin-dev-mode:end\s+\*\*\//i,$i=window.Vaadin&&window.Vaadin.Flow&&window.Vaadin.Flow.clients;function Fi(e,t){if("function"!=typeof e)return;const i=Mi.exec(e.toString());if(i)try{e=new Function(i[1])}catch(e){console.log("vaadin-development-mode-detector: uncommentAndRun() failed",e)}return e(t)}window.Vaadin=window.Vaadin||{};const Bi=function(e,t){if(window.Vaadin.developmentMode)return Fi(e,t)};function Hi(){}void 0===window.Vaadin.developmentMode&&(window.Vaadin.developmentMode=function(){try{return!!localStorage.getItem("vaadin.developmentmode.force")||["localhost","127.0.0.1"].indexOf(window.location.hostname)>=0&&($i?!($i&&Object.keys($i).map((e=>$i[e])).filter((e=>e.productionMode)).length>0):!Fi((function(){return!0})))}catch(e){return!1}}());
/**
 * @license
 * Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
 * This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
 ...
 * Copyright (c) 2021 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */;let no;window.Vaadin||(window.Vaadin={}),window.Vaadin.registrations||(window.Vaadin.registrations=[]),window.Vaadin.developmentModeCallback||(window.Vaadin.developmentModeCallback={}),window.Vaadin.developmentModeCallback["vaadin-usage-statistics"]=function(){Bi(Hi)};const ao=new Set,lo=e=>class extends(ro(e)){static get version(){return"24.1.5"}static finalize(){super.finalize();const{is:e}=this;e&&!ao.has(e)&&(window.Vaadin.registrations.push(this),ao.add(e),window.Vaadin.developmentModeCallback&&(no=Zi.debounce(no,Ki,(()=>{window.Vaadin.developmentModeCallback["vaadin-usage-statistics"]()})),Qi(no)))}constructor(){super(),null===document.doctype&&console.warn('Vaadin components require the "standards mode" declaration. Please add <!DOCTYPE html> to the HTML document.')}}
/**
 * @license
 * Copyright (c) 2021 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 ...
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
class uo extends(co(lo(me(Vi)))){static get template(){return Ri`
      <style>
        :host {
          display: block;
          max-width: 100%;
 ...
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */
class _o extends(me(ro(Vi))){static get is(){return"vaadin-input-container"}static get template(){return Ri`
      <style>
        :host {
          display: flex;
          align-items: center;
...
`;de("",Bs,{moduleId:"lumo-menu-overlay-core"});de("",[bs,Bs,r`
...
`],{moduleId:"lumo-menu-overlay"});de("vaadin-combo-box-overlay",[bs,Bs,r`
  [part='content'] {
    padding: 0;
  }
 ...
 * Copyright (c) 2015 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */;class Us extends(Hs(me(ro(Vi)))){static get template(){return Ri`
      <style>
        :host {
          display: block;
        }
 ...
 */;let Ks;de("vaadin-combo-box-overlay",r`
  ...
  `,{moduleId:"vaadin-combo-box-overlay-styles"});class Js extends(Gs($s)){static get is(){return"vaadin-combo-box-overlay"}static get template(){if(!Ks){Ks=super.template.cloneNode(!0);const e=Ks.content.querySelector('[part~="overlay"]');e.removeAttribute("tabindex");const t=document.createElement("div");t.setAttribute("part","loader"),e.insertBefore(t,e.firstElementChild)}return Ks}}customElements.define(Js.is,Js);
/**
 * @license
 ...
 * Copyright (c) 2015 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */class rr extends(sr(Vi)){static get is(){return"vaadin-combo-box-scroller"}static get template(){return Ri`
      <style>
        :host {
          display: block;
          min-height: 1px;
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
const mr=!1,_r=e=>e,fr="string"==typeof document.head.style.touchAction,vr="__polymerGestures",gr="__polymerGesturesHandled",br="__polymerGesturesTouchAction",yr=["mousedown","mousemove","mouseup","click"],xr=[0,1,4,2],wr=function(){try{return 1===new MouseEvent("test",{buttons:1}).buttons}catch(e){return!1}}();function Cr(e){return yr.indexOf(e)>-1}let Ar=!1;function Er(e){if(!Cr(e)&&"touchend"!==e)return fr&&Ar&&mr?{passive:!0}:void 0}!function(){try{const e=Object.defineProperty({},"passive",{get(){Ar=!0}});window.addEventListener("test",null,e),window.removeEventListener("test",null,e)}catch(e){}}();const Ir=navigator.userAgent.match(/iP(?:[oa]d|hone)|Android/u),Pr={button:!0,command:!0,fieldset:!0,input:!0,keygen:!0,optgroup:!0,option:!0,select:!0,textarea:!0};function Sr(e){const t=e.type;if(!Cr(t))return!1;if("mousemove"===t){let t=void 0===e.buttons?1:e.buttons;return e instanceof window.MouseEvent&&!wr&&(t=xr[e.which]||0),Boolean(1&t)}return 0===(void 0===e.button?0:e.button)}const Tr={mouse:{target:null,mouseIgnoreJob:null},touch:{x:0,y:0,id:-1,scrollDecided:!1}};function Or(e,t,i){e.movefn=t,e.upfn=i,document.addEventListener("mousemove",t),document.addEventListener("mouseup",i)}function kr(e){document.removeEventListener("mousemove",e.movefn),document.removeEventListener("mouseup",e.upfn),e.movefn=null,e.upfn=null}const Nr=window.ShadyDOM&&window.ShadyDOM.noPatch?window.ShadyDOM.composedPath:e=>e.composedPath&&e.composedPath()||[],zr={},Lr=[];function Rr(e){const t=Nr(e);return t.length>0?t[0]:e.target}function Dr(e){const t=e.type,i=e.currentTarget[vr];if(!i)return;const o=i[t];if(!o)return;if(!e[gr]&&(e[gr]={},t.startsWith("touch"))){const i=e.changedTouches[0];if("touchstart"===t&&1===e.touches.length&&(Tr.touch.id=i.identifier),Tr.touch.id!==i.identifier)return;fr||"touchstart"!==t&&"touchmove"!==t||function(e){const t=e.changedTouches[0],i=e.type;if("touchstart"===i)Tr.touch.x=t.clientX,Tr.touch.y=t.clientY,Tr.touch.scrollDecided=!1;else if("touchmove"===i){if(Tr.touch.scrollDecided)return;Tr.touch.scrollDecided=!0;const i=function(e){let t="auto";const i=Nr(e);for(let e,o=0;o<i.length;o++)if(e=i[o],e[br]){t=e[br];break}return t}(e);let o=!1;const s=Math.abs(Tr.touch.x-t.clientX),r=Math.abs(Tr.touch.y-t.clientY);e.cancelable&&("none"===i?o=!0:"pan-x"===i?o=r>s:"pan-y"===i&&(o=s>r)),o?e.preventDefault():Fr("track")}}(e)}const s=e[gr];if(!s.skip){for(let t,i=0;i<Lr.length;i++)t=Lr[i],o[t.name]&&!s[t.name]&&t.flow&&t.flow.start.indexOf(e.type)>-1&&t.reset&&t.reset();for(let i,r=0;r<Lr.length;r++)i=Lr[r],o[i.name]&&!s[i.name]&&(s[i.name]=!0,i[t](e))}}function Vr(e,t,i){return!!zr[t]&&(function(e,t,i){const o=zr[t],s=o.deps,r=o.name;let n=e[vr];n||(e[vr]=n={});for(let t,i,o=0;o<s.length;o++)t=s[o],Ir&&Cr(t)&&"click"!==t||(i=n[t],i||(n[t]=i={_count:0}),0===i._count&&e.addEventListener(t,Dr,Er(t)),i[r]=(i[r]||0)+1,i._count=(i._count||0)+1);e.addEventListener(t,i),o.touchAction&&function(e,t){fr&&e instanceof HTMLElement&&Ji.run((()=>{e.style.touchAction=t}));e[br]=t}(e,o.touchAction)}(e,t,i),!0)}function Mr(e){Lr.push(e),e.emits.forEach((t=>{zr[t]=e}))}function $r(e,t,i){const o=new Event(t,{bubbles:!0,cancelable:!0,composed:!0});if(o.detail=i,_r(e).dispatchEvent(o),o.defaultPrevented){const e=i.preventer||i.sourceEvent;e&&e.preventDefault&&e.preventDefault()}}function Fr(e){const t=function(e){for(let t,i=0;i<Lr.length;i++){t=Lr[i];for(let i,o=0;o<t.emits.length;o++)if(i=t.emits[o],i===e)return t}return null}(e);t.info&&(t.info.prevent=!0)}function Br(e,t,i,o){t&&$r(t,e,{x:i.clientX,y:i.clientY,sourceEvent:i,preventer:o,prevent:e=>Fr(e)})}function Hr(e,t,i){if(e.prevent)return!1;if(e.started)return!0;const o=Math.abs(e.x-t),s=Math.abs(e.y-i);return o>=5||s>=5}function Ur(e,t,i){if(!t)return;const o=e.moves[e.moves.length-2],s=e.moves[e.moves.length-1],r=s.x-e.x,n=s.y-e.y;let a,l=0;o&&(a=s.x-o.x,l=s.y-o.y),$r(t,"track",{state:e.state,x:i.clientX,y:i.clientY,dx:r,dy:n,ddx:a,ddy:l,sourceEvent:i,hover:()=>function(e,t){let i=document.elementFromPoint(e,t),o=i;for(;o&&o.shadowRoot&&!window.ShadyDOM;){const s=o;if(o=o.shadowRoot.elementFromPoint(e,t),s===o)break;o&&(i=o)}return i}(i.clientX,i.clientY)})}function qr(e,t,i){const o=Math.abs(t.clientX-e.x),s=Math.abs(t.clientY-e.y),r=Rr(i||t);!r||Pr[r.localName]&&r.hasAttribute("disabled")||(isNaN(o)||isNaN(s)||o<=25&&s<=25||function(e){if("click"===e.type){if(0===e.detail)return!0;const t=Rr(e);if(!t.nodeType||t.nodeType!==Node.ELEMENT_NODE)return!0;const i=t.getBoundingClientRect(),o=e.pageX,s=e.pageY;return!(o>=i.left&&o<=i.right&&s>=i.top&&s<=i.bottom)}return!1}(t))&&(e.prevent||$r(r,"tap",{x:t.clientX,y:t.clientY,sourceEvent:t,preventer:i}))}
/**
 * @license
 * Copyright (c) 2021 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */Mr({name:"downup",deps:["mousedown","touchstart","touchend"],flow:{start:["mousedown","touchstart"],end:["mouseup","touchend"]},emits:["down","up"],info:{movefn:null,upfn:null},reset(){kr(this.info)},mousedown(e){if(!Sr(e))return;const t=Rr(e),i=this;Or(this.info,(e=>{Sr(e)||(Br("up",t,e),kr(i.info))}),(e=>{Sr(e)&&Br("up",t,e),kr(i.info)})),Br("down",t,e)},touchstart(e){Br("down",Rr(e),e.changedTouches[0],e)},touchend(e){Br("up",Rr(e),e.changedTouches[0],e)}}),Mr({name:"track",touchAction:"none",deps:["mousedown","touchstart","touchmove","touchend"],flow:{start:["mousedown","touchstart"],end:["mouseup","touchend"]},emits:["track"],info:{x:0,y:0,state:"start",started:!1,moves:[],addMove(e){this.moves.length>2&&this.moves.shift(),this.moves.push(e)},movefn:null,upfn:null,prevent:!1},reset(){this.info.state="start",this.info.started=!1,this.info.moves=[],this.info.x=0,this.info.y=0,this.info.prevent=!1,kr(this.info)},mousedown(e){if(!Sr(e))return;const t=Rr(e),i=this,o=e=>{const o=e.clientX,s=e.clientY;Hr(i.info,o,s)&&(i.info.state=i.info.started?"mouseup"===e.type?"end":"track":"start","start"===i.info.state&&Fr("tap"),i.info.addMove({x:o,y:s}),Sr(e)||(i.info.state="end",kr(i.info)),t&&Ur(i.info,t,e),i.info.started=!0)};Or(this.info,o,(e=>{i.info.started&&o(e),kr(i.info)})),this.info.x=e.clientX,this.info.y=e.clientY},touchstart(e){const t=e.changedTouches[0];this.info.x=t.clientX,this.info.y=t.clientY},touchmove(e){const t=Rr(e),i=e.changedTouches[0],o=i.clientX,s=i.clientY;Hr(this.info,o,s)&&("start"===this.info.state&&Fr("tap"),this.info.addMove({x:o,y:s}),Ur(this.info,t,i),this.info.state="track",this.info.started=!0)},touchend(e){const t=Rr(e),i=e.changedTouches[0];this.info.started&&(this.info.state="end",this.info.addMove({x:i.clientX,y:i.clientY}),Ur(this.info,t,i))}}),Mr({name:"tap",deps:["mousedown","click","touchstart","touchend"],flow:{start:["mousedown","touchstart"],end:["click","touchend"]},emits:["tap"],info:{x:NaN,y:NaN,prevent:!1},reset(){this.info.x=NaN,this.info.y=NaN,this.info.prevent=!1},mousedown(e){Sr(e)&&(this.info.x=e.clientX,this.info.y=e.clientY)},click(e){Sr(e)&&qr(this.info,e)},touchstart(e){const t=e.changedTouches[0];this.info.x=t.clientX,this.info.y=t.clientY},touchend(e){qr(this.info,e.changedTouches[0],e)}});const jr=e=>class extends(Vo(Fo(e))){get _activeKeys(){return[" "]}ready(){super.ready(),Vr(this,"down",(e=>{this._shouldSetActive(e)&&this._setActive(!0)})),Vr(this,"up",(()=>{this._setActive(!1)}))}disconnectedCallback(){super.disconnectedCallback(),this._setActive(!1)}_shouldSetActive(e){return!this.disabled}_onKeyDown(e){super._onKeyDown(e),this._shouldSetActive(e)&&this._activeKeys.includes(e.key)&&(this._setActive(!0),document.addEventListener("keyup",(e=>{this._activeKeys.includes(e.key)&&this._setActive(!1)}),{once:!0}))}_setActive(e){this.toggleAttribute("active",e)}}
/**
 * @license
 * Copyright (c) 2021 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
 */,Wr=tt((e=>class extends(ds(Vo(Yo(e)))){static get properties(){return{checked:{type:Boolean,value:!1,notify:!0,reflectToAttribute:!0}}}static get delegateProps(){return[...super.delegateProps,"checked"]}_onChange(e){const t=e.target;this._toggleChecked(t.checked),Lo(t)||t.focus()}_toggleChecked(e){this.checked=e}})),Yr=e=>class extends(ns(Wr($o(jr(e))))){static get properties(){return{indeterminate:{type:Boolean,notify:!0,value:!1,reflectToAttribute:!0},name:{type:String,value:""}}}static get delegateProps(){return[...super.delegateProps,"indeterminate"]}static get delegateAttrs(){return[...super.delegateAttrs,"name"]}constructor(){super(),this._setType("checkbox"),this.value="on"}ready(){super.ready(),this.addController(new To(this,(e=>{this._setInputElement(e),this._setFocusElement(e),this.stateTarget=e,this.ariaTarget=e}))),this.addController(new _s(this.inputElement,this._labelController))}_shouldSetActive(e){return"a"!==e.target.localName&&super._shouldSetActive(e)}_toggleChecked(e){this.indeterminate&&(this.indeterminate=!1),super._toggleChecked(e)}}
/**
 * @license
 * Copyright (c) 2017 - 2023 Vaadin Ltd.
 * This program is available under Apache License Version 2.0, available at https://vaadin.com/license/
...
`,{moduleId:"vaadin-checkbox-styles"});class Gr extends(Yr(lo(me(Vi)))){static get is(){return"vaadin-checkbox"}static get template(){return Ri`
 ...
 */
class on extends oe{render(){return V`<span class="shadow"></span>`}}
/**
  * @license
  * Copyright 2022 Google LLC
  * SPDX-License-Identifier: Apache-2.0
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */const fn=(e=>(...t)=>({_$litDirective$:e,values:t}))(class extends _n{constructor(e){var t;if(super(e),e.type!==mn||"class"!==e.name||(null===(t=e.strings)||void 0===t?void 0:t.length)>2)throw Error("`classMap()` can only be used in the `class` attribute and must be the only part in the attribute.")}render(e){return" "+Object.keys(e).filter((t=>e[t])).join(" ")+" "}update(e,[t]){var i,o;if(void 0===this.it){this.it=new Set,void 0!==e.strings&&(this.nt=new Set(e.strings.join(" ").split(/\s/).filter((e=>""!==e))));for(const e in t)t[e]&&!(null===(i=this.nt)||void 0===i?void 0:i.has(e))&&this.it.add(e);return this.render(t)}const s=e.element.classList;this.it.forEach((e=>{e in t||(s.remove(e),this.it.delete(e))}));for(const e in t){const i=!!t[e];i===this.it.has(e)||(null===(o=this.nt)||void 0===o?void 0:o.has(e))||(i?(s.add(e),this.it.add(e)):(s.remove(e),this.it.delete(e)))}return M}}),vn="cubic-bezier(0.2, 0, 0, 1)";
/**
 * @license
 * Copyright 2021 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 ...
 * Copyright 2022 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */;let On=class extends In{};On.styles=[Tn,Pn,Sn],On=Kr([Jr("md-fab")],On);
/**
 * @license
 * Copyright 2022 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */
class kn extends oe{render(){return V`<span><slot></slot></span>`}}
/**
  * @license
  * Copyright 2022 Google LLC
  * SPDX-License-Identifier: Apache-2.0
