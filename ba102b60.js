...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/let it={},st={};function ot(e,t){it[e]=st[e.toLowerCase()]=t}function rt(e){return it[e]||st[e.toLowerCase()]}class nt extends HTMLElement{static get observedAttributes(){return["id"]}static import(e,t){if(e){let i=rt(e);return i&&t?i.querySelector(t):i}return null}attributeChangedCallback(e,t,i,s){t!==i&&this.register()}get assetpath(){if(!this.__assetpath){const e=window.HTMLImports&&HTMLImports.importForElement?HTMLImports.importForElement(this)||document:this.ownerDocument,t=De(this.getAttribute("assetpath")||"",e.baseURI);this.__assetpath=$e(t)}return this.__assetpath}register(e){if(e=e||this.id){if(qe&&void 0!==rt(e))throw ot(e,null),new Error(`strictTemplatePolicy: dom-module ${e} re-registered`);this.id=e,ot(e,this),(t=this).querySelector("style")&&console.warn("dom-module %s has style outside template",t.id)}var t}}nt.prototype.modules=it,customElements.define("dom-module",nt);
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/
const at="link[rel=import][type~=css]",lt="include",dt="shady-unscoped";function ht(e){return nt.import(e)}function ct(e){const t=Me((e.body?e.body:e).textContent,e.baseURI),i=document.createElement("style");return i.textContent=t,i}function ut(e){const t=e.trim().split(/\s+/),i=[];for(let e=0;e<t.length;e++)i.push(...pt(t[e]));return i}function pt(e){const t=ht(e);if(!t)return console.warn("Could not find style data in module named",e),[];if(void 0===t._styles){const e=[];e.push(..._t(t));const i=t.querySelector("template");i&&e.push(...mt(i,t.assetpath)),t._styles=e}return t._styles}function mt(e,t){if(!e._styles){const i=[],s=e.content.querySelectorAll("style");for(let e=0;e<s.length;e++){let o=s[e],r=o.getAttribute(lt);r&&i.push(...ut(r).filter((function(e,t,i){return i.indexOf(e)===t}))),t&&(o.textContent=Me(o.textContent,t)),i.push(o)}e._styles=i}return e._styles}function _t(e){const t=[],i=e.querySelectorAll(at);for(let e=0;e<i.length;e++){let s=i[e];if(s.import){const e=s.import,i=s.hasAttribute(dt);if(i&&!e._unscopedStyle){const t=ct(e);t.setAttribute(dt,""),e._unscopedStyle=t}else e._style||(e._style=ct(e));t.push(i?e._unscopedStyle:e._style)}}return t}
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/let Rt=!1,Dt=!1;function Mt(e){(function(){if(!Rt){Rt=!0;const e=document.createElement("textarea");e.placeholder="a",Dt=e.placeholder===e.textContent}return Dt})()&&"textarea"===e.localName&&e.placeholder&&e.placeholder===e.textContent&&(e.textContent=null)}const $t=(()=>{const e=window.trustedTypes&&window.trustedTypes.createPolicy("polymer-template-event-attribute-policy",{createScript:e=>e});return(t,i,s)=>{const o=i.getAttribute(s);e&&s.startsWith("on-")?t.setAttribute(s,e.createScript(o,s)):t.setAttribute(s,o)}})();function Bt(e){let t=e.getAttribute("is");if(t&&Vt[t]){let i=e;for(i.removeAttribute("is"),e=i.ownerDocument.createElement(t),i.parentNode.replaceChild(e,i),e.appendChild(i);i.attributes.length;){const{name:t}=i.attributes[0];$t(e,i,t),i.removeAttribute(t)}}return e}function Ft(e,t){let i=t.parentInfo&&Ft(e,t.parentInfo);if(!i)return e;for(let e=i.firstChild,s=0;e;e=e.nextSibling)if(t.parentIndex===s++)return e}function Ht(e,t,i,s){s.id&&(t[s.id]=i)}function Ut(e,t,i){if(i.events&&i.events.length)for(let s,o=0,r=i.events;o<r.length&&(s=r[o]);o++)e._addMethodEventListenerToNode(t,s.name,s.value,e)}function qt(e,t,i,s){i.templateInfo&&(t._templateInfo=i.templateInfo,t._parentTemplateInfo=s)}const jt=tt((e=>class extends e{static _parseTemplate(e,t){if(!e._templateInfo){let i=e._templateInfo={};i.nodeInfoList=[],i.nestedTemplate=Boolean(t),i.stripWhiteSpace=t&&t.stripWhiteSpace||e.hasAttribute&&e.hasAttribute("strip-whitespace"),this._parseTemplateContent(e,i,{parent:null})}return e._templateInfo}static _parseTemplateContent(e,t,i){return this._parseTemplateNode(e.content,t,i)}static _parseTemplateNode(e,t,i){let s=!1,o=e;return"template"!=o.localName||o.hasAttribute("preserve-content")?"slot"===o.localName&&(t.hasInsertionPoint=!0):s=this._parseTemplateNestedTemplate(o,t,i)||s,Mt(o),o.firstChild&&this._parseTemplateChildNodes(o,t,i),o.hasAttributes&&o.hasAttributes()&&(s=this._parseTemplateNodeAttributes(o,t,i)||s),s||i.noted}static _parseTemplateChildNodes(e,t,i){if("script"!==e.localName&&"style"!==e.localName)for(let s,o=e.firstChild,r=0;o;o=s){if("template"==o.localName&&(o=Bt(o)),s=o.nextSibling,o.nodeType===Node.TEXT_NODE){let i=s;for(;i&&i.nodeType===Node.TEXT_NODE;)o.textContent+=i.textContent,s=i.nextSibling,e.removeChild(i),i=s;if(t.stripWhiteSpace&&!o.textContent.trim()){e.removeChild(o);continue}}let n={parentIndex:r,parentInfo:i};this._parseTemplateNode(o,t,n)&&(n.infoIndex=t.nodeInfoList.push(n)-1),o.parentNode&&r++}}static _parseTemplateNestedTemplate(e,t,i){let s=e,o=this._parseTemplate(s,t);return(o.content=s.content.ownerDocument.createDocumentFragment()).appendChild(s.content),i.templateInfo=o,!0}static _parseTemplateNodeAttributes(e,t,i){let s=!1,o=Array.from(e.attributes);for(let r,n=o.length-1;r=o[n];n--)s=this._parseTemplateNodeAttribute(e,t,i,r.name,r.value)||s;return s}static _parseTemplateNodeAttribute(e,t,i,s,o){return"on-"===s.slice(0,3)?(e.removeAttribute(s),i.events=i.events||[],i.events.push({name:s.slice(3),value:o}),!0):"id"===s&&(i.id=o,!0)}static _contentForTemplate(e){let t=e._templateInfo;return t&&t.content||e.content}_stampTemplate(e,t){e&&!e.content&&window.HTMLTemplateElement&&HTMLTemplateElement.decorate&&HTMLTemplateElement.decorate(e);let i=(t=t||this.constructor._parseTemplate(e)).nodeInfoList,s=t.content||e.content,o=document.importNode(s,!0);o.__noInsertionPoint=!t.hasInsertionPoint;let r=o.nodeList=new Array(i.length);o.$={};for(let e,s=0,n=i.length;s<n&&(e=i[s]);s++){let i=r[s]=Ft(o,e);Ht(0,o.$,i,e),qt(0,i,e,t),Ut(this,i,e)}return o}_addMethodEventListenerToNode(e,t,i,s){let o=function(e,t,i){return e=e._methodHost||e,function(t){e[i]?e[i](t,t.detail):console.warn("listener method `"+i+"` not defined")}}(s=s||e,0,i);return this._addEventListenerToNode(e,t,o),o}_addEventListenerToNode(e,t,i){e.addEventListener(t,i)}_removeEventListenerFromNode(e,t,i){e.removeEventListener(t,i)}}));
/**
 * @fileoverview
 ...
 * Copyright 2022 Google LLC
 * SPDX-License-Identifier: Apache-2.0
 */;let Zr=class extends Kr{};Zr.styles=[Jr],Zr=mr([_r("md-icon")],Zr);customElements.define("esi-app",class extends se{static get properties(){return{title:{type:String},life_saving:{type:String},high_risk:{type:String},num_resources:{type:String},edad:{type:String}}}static get styles(){return r`:host{--background-color:#ededed;--header-background-color:rgb(52, 143, 255);--header-color:#fff;--content-font-size:calc(10px + 2vmin);--default-padding:1rem;--default-box-sizing:border-box;--primary-font-size:1.5rem;--primary-line-height:1.5rem;--primary-font-weight:400;--label-font-size:1.2rem;--esi-uno-color:#fff;--esi-uno-background-color:#ff0000;--esi-dos-background-color:orange;min-height:100vh;display:flex;flex-direction:column;align-items:center;justify-content:flex-start;font-size:var(--content-font-size);color:#1a2b42;margin:0 auto;text-align:center;background-color:var(--background-color);height:100%;box-sizing:var(--default-box-sizing)}.def-esi-uno,.ejemplos,.esi-uno,vaadin-form-layout{box-sizing:var(--default-box-sizing);padding:var(--default-padding)}main{flex-grow:1;padding:0}main>div{max-width:720px;margin:var(--default-padding) auto;background-color:#fff;height:calc(100vh - 72px - 2 * var(--default-padding));border-radius:.5rem}header{display:flex;flex-direction:row;align-items:center;justify-content:space-between;width:100vw;height:auto;background-color:var(--header-background-color);color:var(--header-color);font-size:var(--primary-font-size);padding:calc(var(--default-padding)/ 2) var(--default-padding);box-sizing:var(--default-box-sizing)}header h1{margin:0;font-size:var(--primary-font-size);font-weight:var(--primary-font-weight);line-height:var(--primary-line-height);text-align:left}.esi-uno{background-color:var(--esi-uno-background-color);color:var(--esi-uno-color);font-size:var(--primary-font-size);font-weight:var(--primary-font-weight);line-height:var(--primary-line-height);text-align:center}.esi-dos{background-color:var(--esi-dos-background-color);color:var(--esi-uno-color)}.ejemplos,label{font-size:var(--label-font-size)}md-fab{position:fixed;bottom:var(--default-padding);right:var(--default-padding)}.def-esi-uno{display:block;color:var(--esi-uno-text-color,#000);font-size:1.2rem;text-align:left}.def-esi-uno>img{width:100%}.recargar{--mdc-theme-primary:var(--header-background-color);--mdc-theme-on-primary:var(--header-color)}`}constructor(){super(),this.title="Categorización ESI CPM",this.life_saving=null,window.isUpdateAvailable.then((e=>{!0===e&&(window.prompt("Hay una nueva versión disponible, ¿recargar?","Recargar"),window.location.reload())}))}render(){return D` <main> <header> <h1>${this.title}</h1> <a href="https://github.com/nicoveraz/esi-app" target="_blank"> <img src="./assets/github.svg" alt="GitHub Logo" width="32" height="32"> </a> </header> <div> ${this.renderLifeSavingQuestion()} ${this.renderHighRiskQuestion()} ${this.renderResourceAgeQuestions()} </div> <md-fab @click="${this.reset}"><md-icon slot="icon">restart_alt</md-icon></md-fab> </main> `}renderLifeSavingQuestion(){return D` <vaadin-form-layout> <vaadin-combo-box clear-button-visible label="¿Requiere intervención inmediata para salvar su vida?" @change="${e=>this.life_saving=e.target.value}" .value="${this.life_saving}" .items="${["SI","NO"]}"> </vaadin-combo-box> </vaadin-form-layout> ${this.life_saving?"":this.renderDefEsiUno()} ${"SI"===this.life_saving?this.renderEsiOne():""} `}renderEsiOne(){return D` <div class="esi-uno">ESI 1</div> ${this.renderDefEsiUno()} `}renderHighRiskQuestion(){return"NO"===this.life_saving?D` <vaadin-form-layout> <vaadin-combo-box clear-button-visible label="¿Situación de alto riesgo?" @change="${e=>this.high_risk=e.target.value}" .value="${this.high_risk}" .items="${["SI","NO"]}"> </vaadin-combo-box> </vaadin-form-layout> ${this.high_risk?"":this.renderDefEsiDos()} ${"SI"===this.high_risk?this.renderEsiTwo():""} `:""}renderEsiTwo(){return D` <div class="esi-uno esi-dos">ESI 2</div> ${this.renderDefEsiDos()} `}renderResourceAgeQuestions(){return"NO"===this.high_risk?D` <vaadin-form-layout> <vaadin-combo-box clear-button-visible label="¿Cuántos recursos diferentes se necesitan?" @change="${e=>this.num_resources=e.target.value}" .value="${this.num_resources}" .items="${["Ninguno","Uno","Muchos"]}"> </vaadin-combo-box> <vaadin-combo-box clear-button-visible label="Edad" @change="${e=>this.edad=e.target.value}" .value="${this.edad}" .items="${["<1m","1-12m","1-3a","3-5a","5-12a","12-18a",">18a"]}"> </vaadin-combo-box> </vaadin-form-layout> `:""}renderDefEsiUno(){return D` <div class="def-esi-uno"> <p><strong>Intervención inmediata para salvar la vida:</strong> Soporte de vía aérea o respiratorio, medicamentos de emergencia, intervenciones hemodinámicas como reanimación con líquidos o productos sanguíneos.</p> <p><strong>Las presentaciones clínicas que requieren intervenciones para salvar la vida incluyen las siguientes:</strong></p> <ul> <li>Intubado</li> <li>Inconsciente</li> <li>Sin pulso</li> <li>Dificultad respiratoria severa</li> <li>Hipotensión profunda</li> <li>Hipoglicemia</li> </ul> <p><strong>La inconsciencia se define como un paciente que:</strong></p> <ol> <li>No es verbal y no sigue órdenes (agudamente)</li> <p>Ó</p> <li>Requiere estímulo nocivo (D o I en la escala AVDI)</li> </ol> <img src="./assets/avdi.jpg" alt="Escala AVDI"> </div> `}renderDefEsiDos(){return D` <div class="def-esi-uno"> <p><strong>¿debería esperar el paciente?</strong>Si la respuesta es “NO”, se clasifica como nivel 2</p> <p><strong>Se utilizan 3 preguntas generales para determinar si el paciente cumple con los criterios correspondientes al nivel 2:</strong></p> <ol> <li>¿Es una situación de alto riesgo?</li> <li>¿El paciente está confundido, letárgico o desorientado?</li> <li>¿El paciente experimenta dolor o malestar severo?</li> </ol> <p>En este ítem se debe aplicar Escala numérica del dolor y AVDI</p> <img src="./assets/avdi.jpg" alt="Escala AVDI"> <img src="./assets/eva.jpg" alt="Escala EVA"> </div> `}reset(){this.life_saving=null,this.high_risk=null,this.num_resources=null,this.edad=null}});
